...
void ASimplePawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...

	{
		...
		PlayerInputComponent->BindAxis("LookUp", this, &ASimplePawn::AddControllerPitchInput);

		//BIND axis "LookRight" to this objects APawn's AddControllerYawInput Function
		PlayerInputComponent->BindAxis("LookRight", this, &ASimplePawn::AddControllerYawInput);
	}
	//ENDIF
}
